  ...
  return (
    <>
      <div className='flex flex-row gap-4 mr-1 justify-center md:justify-end '>
        <a className='border border-white bg-black text-white flex items-center gap-2 py-3 px-3 md:px-4 lg:px-10 hover:shadow-md shadow-stone-100/10'
          href="#contact"
        >
          contact me
        ...
        <a className='border border-gray-500 flex items-center gap-2 py-3 px-3 md:px-4 lg:px-10 hover:shadow-md shadow-stone-100/10'
